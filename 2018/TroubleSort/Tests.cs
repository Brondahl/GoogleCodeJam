namespace TroubleSort
{
  ...
  public class Tests
  {
    ...
    {
      new CaseSolver(new CaseInput(new[] { inputString1, inputString2 })).Solve().ErrorIndex.Should().Be(expectedOutput);
    }
    ...
    {
      var input = new CaseInput(new[] { inputString1, inputString2 });
